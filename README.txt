...
a persistence unit "evaluativoMorochoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "evaluativoMorocho/pom.xml":
...
artifact ("evaluativoMorocho.war") is already built. You can build
